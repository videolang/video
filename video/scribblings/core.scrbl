...
@deprecated-text{The documentation for this page is out of
 date. Currently the best way to learn about the core of
 video is to look at @racketmodname[video/private/video]. Note
 that this module is not stable and will change.}
