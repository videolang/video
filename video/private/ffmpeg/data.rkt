...
(define-ffmpeg-cstruct _avcodec-context
  ...
  ([av-class _pointer]
   ...
   [me-range _int]
   [intra-quant-bias _int #:removed 58]
   [inter-quant-bias _int #:removed 58]
   ...
   [me-threashold _int #:removed 58]
   [mb-threashold _int #:removed 58]
   [intra-dc-precision _int]
   [skip-top _int]
   [skip-bottom _int]
   [border-masking _float #:removed 58]
   [mb-lmin _int]
   [mb-lmax _int]
   ...
   [qmax _int]
   [max-qdiff _int]
   [rc-qsquish _float #:removed 58]
   [rc-qmod-amp _float #:removed 58]
   [rc-qmod-freq _int #:removed 58]
   [rc-buffer-size _int]
   [rc-override-count _int]
   [rc-override _pointer]
   [rc-eq _bytes #:removed 58]
   [rc-max-rate _int64]
   [rc-min-rate _int64]
   [rc-buffer-aggressivity _float #:removed 58]
   [rc-initial-cpix _float #:removed 58]
   ...
   [lmin _int #:removed 58]
   [lmax _int #:removed 58]
   ...
   [timecode-frame-start _int64 #:removed 59]
   ...
   [bits-per-coded-sample _int]
   [bits-per-raw-sample _int]
   [lowres _int #:removed 59]
   [coded-frame _pointer #:removed 59]
   [thread-count _int]
   [thread-type _int]
   ...
   [execute _fpointer]
   [execute2 _fpointer]
   [thread-opaque _pointer #:removed 57]
   [nsse_weight _int]
   [profile _int] ;; <- TODO, handle
   [level _int]
   ...
   [error-rate _int #:removed 59]
   [pkt _pointer #:removed 57]
   [vbv-delay _uint64 #:removed 59]
   [side-data-only-packets _int #:removed 59]
   [initial-padding _int]
   [framerate _avrational]
   [sw-pix-fmt _avpixel-format]
   [pkt-timebase _avrational]
   [codec-discriptor _pointer]
   [lowres* _int #:added 59]
   ...
   [max-pixels _int64 #:added 58]
   [hw-device-context _pointer #:added 58]
   [hwaccell-flags _int #:added 58]
   [apply-cropping _int #:added 58]
