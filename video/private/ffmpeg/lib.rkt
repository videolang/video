...
(void
 (match (system-type 'os)
   ...
   [_ (void)]))
(define avutil-lib
  (ffi-lib (string-append lib-prefix "avutil") '("56" "55" #f)
...
(define swresample-lib
  (ffi-lib (string-append lib-prefix "swresample") '("3" "2" #f)
           #:fail ffmpeg-not-installed))
(define-ffi-definer define-swresample swresample-lib
  #:default-make-fail error-not-installed
  #:make-c-id convention:hyphen->underscore)
(define swscale-lib
  (ffi-lib (string-append lib-prefix "swscale") '("5" "4" #f)
           #:fail ffmpeg-not-installed))
(define-ffi-definer define-swscale swscale-lib
  #:default-make-fail error-not-installed
  #:make-c-id convention:hyphen->underscore)
(define avcodec-lib
  (ffi-lib (string-append lib-prefix "avcodec") '("58" "57" #f)
           #:fail ffmpeg-not-installed))
(define-ffi-definer define-avcodec avcodec-lib
  #:default-make-fail error-not-installed
  #:make-c-id convention:hyphen->underscore)
(define avformat-lib
  (ffi-lib (string-append lib-prefix "avformat") '("58" "57" #f)
           #:fail ffmpeg-not-installed))
...
(match (system-type 'os)
  ['windows
   (define postproc-lib
     (ffi-lib (string-append lib-prefix "postproc") '("55" "54" #f)))
   (define-ffi-definer define-postproc postproc-lib
     #:make-c-id convention:hyphen->underscore)
   (void)]
  [_ (void)])
(define avfilter-lib
  (ffi-lib (string-append lib-prefix "avfilter") '("7" "6" #f)
           #:fail ffmpeg-not-installed))
(define-ffi-definer define-avfilter avfilter-lib
  #:default-make-fail error-not-installed
  #:make-c-id convention:hyphen->underscore)
(define avdevice-lib
  (ffi-lib (string-append lib-prefix "avdevice") '("58" "57" #f)
           #:fail ffmpeg-not-installed))
